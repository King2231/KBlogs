...
<?php
    $query="SELECT * FROM posts WHERE postby=$user_id ORDER BY post_id DESC";
...
?>
            <div style="font-size: 35px"> Hey...These Are All Your Blogs....;)</div> <hr><hr><br>
<?php
        while($value=mysqli_fetch_array($result)){
            ?>
           <div id="blog">
               <div id="btitle"><u><?php echo $value['title']; ?></u></div>
               <div id="dtime"><?php echo $value['datetime']; ?> &nbsp;&nbsp;&nbsp;<?php if($value['publish']==1){?>PUBLISHED<?php }else{?>UNPUBLISHED<?php }?></div>
               <div id="bontent"><?php echo $value['content']; ?></div>
               <div id="optns"><ul>
               <li>
<?php 
            
                echo "<a href=viewpost.php?post_id=".$value['post_id'].">View</a>";?>
                    
            </li>
            <li>
                <?php if($value['publish']==0){echo "<a href=editpost.php?post_id=".$value['post_id'].">Edit</a>";}?>
                    
            </li>
            <li>
            <?php echo "<a href=delpost.php?post_id=".$value['post_id'].">Delete</a>";?>
            </li>
            </div>
           </div>
           <hr><hr><br>
...
?>
        <div style="font-size: 35px"> Hey...It Seems You Haven't Started Blogging Yet....;)<br>Click Below To Start Blogging.</div>
